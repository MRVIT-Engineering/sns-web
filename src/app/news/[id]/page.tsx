      ...
      <div className="min-h-screen font-[family-name:var(--font-geist-sans)]">
        ...
        <div className="pt-24 pb-16">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
            <h1 className="text-4xl font-playfair font-bold mb-4">Articol negăsit</h1>
            <p className="text-gray-600 mb-8">Articolul pe care îl cauți nu există sau nu este disponibil momentan.</p>
            <Link href="/news" className="inline-flex items-center text-blue-600 hover:text-blue-700">
              <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
              </svg>
